      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              <div className="text-center p-6 rounded-lg border bg-card">
                ...
                <p className="text-sm text-muted-foreground">Get the best audio quality from YouTube videos</p>
              </div>
              ...
              <div className="text-center p-6 rounded-lg border bg-card">
                ...
                <p className="text-sm text-muted-foreground">Convert and download in seconds</p>
              </div>
            ...
            <div className="text-center max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">Paste YouTube URL</p>
                </div>
                <div className="p-4">
                  <div className="w-8 h-8 mx-auto mb-2 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-sm font-bold">
                    2
                  </div>
                  <p className="text-sm text-muted-foreground">Click Convert</p>
                </div>
                <div className="p-4">
                  <div className="w-8 h-8 mx-auto mb-2 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-sm font-bold">
                    3
                  </div>
                  <p className="text-sm text-muted-foreground">Download MP3</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer className="border-t bg-muted/50 mt-16">
          <div className="max-w-6xl mx-auto px-4 py-8 text-center text-sm text-muted-foreground">
            <p>© 2024 YT2MP3. All rights reserved.</p>
            <p className="mt-2">This service is for personal use only. Please respect copyright laws.</p>
          </div>
        </footer>
      </div>
    </>
